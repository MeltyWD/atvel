export default () => {
  ...
  function initRatings() {
    let ratingItem, ratingActive, ratingValue, ratingInput;
    ...
    function InitRatingVars(rating) {
      ...
      ratingInput = rating.querySelector("[data-rating-input]");
    }
    ...
    function setRating(rating) {
      ...
      ratingItems.forEach((elem) => {
        ...
        elem.addEventListener("click", function (e) {
          ...
          ratingInput.value = elem.dataset.ratingItem;
          serRatingActiveWidth(elem.dataset.ratingItem);
        });
      });
    }
